...
# @phenomenelik: chciałem pokazać tyle, że jak w stringu mamy int to możemy przerzucić i dalej robić operacj na intach
...
#trochę po ferrytowemu to zrobiłem
index = 0
while index < len(fortnite_list):
    for playa in fortnite_list:
        print(playa)
        index += 1
...
for emejl in email_list1:
    if 'gmail.com' in emejl:
        print(emejl)
